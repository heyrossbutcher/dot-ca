...
wp_deregister_script('jquery');
  ...
  if(is_home()) {
	  wp_enqueue_script(
	    'patterns', //handle
	    get_template_directory_uri() . '/js/patterns.js', //source
	    false, //dependencies
	    null, // version number
	    true //load in footer
	  );
	  ...
	  wp_enqueue_script(
	    'grid', //handle
	    get_template_directory_uri() . '/js/grid.js', //source
	    false, //dependencies
	    null, // version number
	    true //load in footer
	  );
	  wp_enqueue_script(
	    ...
	    array( 'jquery', 'plugins', 'patterns', 'grid' ), //dependencies
	    null, // version number
	    true //load in footer
	  );
	}else{
		wp_enqueue_script(
		  'scripts', //handle
		  get_template_directory_uri() . '/js/scripts_inner.js', //source
